...
public class GoogleDriveAccess {
	...
	private static final java.io.File DATA_STORE_DIR = new java.io.File(System.getProperty("user.home"), ".credentials/13/drive-java-quickstart.json");
	...
	public static Credential authorize() throws IOException {
		...
		InputStream in = GoogleDriveAccess.class.getResourceAsStream("client_gsecret.json");
